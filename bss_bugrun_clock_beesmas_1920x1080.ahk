...
Sleep, %KeyDuration%
Send, {Enter Up}
Sleep, 22000  ; reset and wait a bit to let bees almost wake up
...
{
    CoordMode, Pixel, Window
    PixelSearch, FoundX, FoundY, 510, 82, 525, 90, 0x5C6085, 35, Fast RGB  ; check night
    Sleep, 20
}
...
{
    CoordMode, Pixel, Window
    PixelSearch, FoundX, FoundY, 1612, 675, 1646, 750, 0x00004F, 50, Fast RGB
    Sleep, 20
}
Until ErrorLevel = 0
Send, {s Up}
